...
public class BAMAgentClassLoader_OLD extends ClassLoader {
	 ...
	 * @throws JarException
	 */
	public BAMAgentClassLoader_OLD(String jarName, ClassLoader parent) throws JarException, IOException {
		super(parent);
		classes = new HashMap<>();
	...
	public BAMAgentClassLoader_OLD(ClassLoader parent) {
		super(parent);
		classes = new HashMap<>();
	}
